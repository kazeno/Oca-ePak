 ...
 *
 * Tested in Prestashop v1.5.0.17, 1.5.6.2, 1.6.0.5, 1.6.1.10, 1.7.0.2
 *
...
class OcaEpak extends CarrierModule
{
    ...
    public function install()
    {
        ...
        return (
            ...
            $db->Execute(
                KznCarrier::interpolateSqlFile($this->name, 'create-branches-table', array(
                    '{$DB_PREFIX}' => _DB_PREFIX_,
                    ...
                    foreach ($postcodes as $postcode) {
                        ...
                        if (count($brs)) {
                            ...
                            $branches[$postcode] = $this->retrieveOcaBranches(self::OCA_SERVICE_DELIVERY,
                                KznCarrier::cleanPostcode($postcode));
    ...
    public function hookDisplayCarrierList($params)
    {
        ...
        if (count($carrierIds)) {
            try {
                ...
                if ($this->context->customer->is_guest || in_array(Tools::getValue('action', ''), array(
